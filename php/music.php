...
<img src="../images/musical-note-icon.svg" alt="Musical Note Icon" id="musical-note-icon" class="start-animation-for-for-musical-note">

<div id="music-section" class="opacity-zero start-animation"></div>
