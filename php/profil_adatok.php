   ...
   <table id="profil-adatok-table">
            ...
            <tr class="signin-form-table-tr">
                ...
                <td class="signin-form-table-td">
                     <?php echo $_SESSION["session-user"]["username"]; ?>
                </td>
            </tr>
            <tr class="signin-form-table-tr">
                <td class="signin-form-table-td">Vezetéknév:</td>
                <td class="signin-form-table-td">
                    <?php echo $_SESSION["session-user"]["firstname"]; ?>
                </td>
            </tr>
            <tr class="signin-form-table-tr">
                <td class="signin-form-table-td">Keresztnév:</td>
                <td class="signin-form-table-td">
                    <?php echo $_SESSION["session-user"]["lastname"]; ?>
                </td>
            </tr>
            <tr class="signin-form-table-tr">
                <td class="signin-form-table-td">Születési dátum:</td>
                <td class="signin-form-table-td"> 
                    <?php echo $_SESSION["session-user"]["birth-date"]; ?>
                </td>
            </tr>
            <tr class="signin-form-table-tr">
                <td class="signin-form-table-td">Műfajok:</td>
                <td class="signin-form-table-td">
                    <?php echo $_SESSION["session-user"]["liked-genres"]; ?>
                </td>
            </tr>
            <tr class="signin-form-table-tr">
                <td class="signin-form-table-td">E-mail:</td>
                <td class="signin-form-table-td">
                    <?php echo $_SESSION["session-user"]["email"]; ?>  
                </td>
            </tr>
            ...
            <tr class="signin-form-table-tr">
                ...
                <td class="signin-form-table-td">
                    <?php echo $_SESSION["session-user"]["introduction"]; ?>
                </td>
            </tr>
